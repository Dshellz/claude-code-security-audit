...
user-controlled input (Server Action arguments, `searchParams`, `params`, Route Handler bodies, headers, cookies), follow the data to dangerous sinks: SQL query,
