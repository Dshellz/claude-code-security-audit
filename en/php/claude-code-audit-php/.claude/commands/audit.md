...
user-controlled input (`$_GET`, `$_POST`, `$_REQUEST`, `$_COOKIE`, headers, JSON body, `$_FILES`, `$request->...`), follow the data to dangerous sinks: SQL query,
