---
description: White-box security audit of pending changes (Django / DRF)
argument-hint: "[optional path to audit]"
allowed-tools: Bash(git status:*), Bash(git diff:*), Bash(git log:*), Read, Grep, Glob
---

# /audit - White-box security audit (Django / DRF)
...
user-controlled input (`request.GET`, `request.POST`, `request.data`, URL kwargs, headers, cookies), follow the data to dangerous sinks: SQL query,
