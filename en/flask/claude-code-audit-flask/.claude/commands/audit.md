...
user-controlled input (`request.args`, `request.form`, `request.json`, `request.files`, headers, cookies), follow the data to dangerous sinks: SQL query,
