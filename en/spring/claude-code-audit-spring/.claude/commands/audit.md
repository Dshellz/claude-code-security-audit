---
description: White-box security audit of pending changes (Java / Spring Boot)
argument-hint: "[optional path to audit]"
allowed-tools: Bash(git status:*), Bash(git diff:*), Bash(git log:*), Read, Grep, Glob
---

# /audit - White-box security audit (Java / Spring Boot)
...
user-controlled input (`@RequestParam`, `@PathVariable`, `@RequestBody`, headers, cookies), follow the data to dangerous sinks: SQL query,
