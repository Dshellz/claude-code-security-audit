---
description: White-box security audit of pending changes (Node.js / Express)
argument-hint: "[optional path to audit]"
allowed-tools: Bash(git status:*), Bash(git diff:*), Bash(git log:*), Read, Grep, Glob
---

# /audit - White-box security audit (Node.js / Express)
...
user-controlled input (`req.params`, `req.query`, `req.body`, `req.headers`, `req.cookies`), follow the data to dangerous sinks: SQL query,
