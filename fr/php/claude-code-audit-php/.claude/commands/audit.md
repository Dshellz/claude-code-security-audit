...
Pour chaque entrée contrôlée par l'utilisateur (`$_GET`, `$_POST`, `$_REQUEST`, `$_COOKIE`, en-têtes, corps JSON, `$_FILES`, `$request->...`), suis la donnée jusqu'aux
