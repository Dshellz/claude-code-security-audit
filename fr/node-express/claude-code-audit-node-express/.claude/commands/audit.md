---
description: Audit de sécurité white-box des changements en cours (Node.js / Express)
argument-hint: "[chemin optionnel à auditer]"
allowed-tools: Bash(git status:*), Bash(git diff:*), Bash(git log:*), Read, Grep, Glob
---

# /audit - Audit de sécurité white-box (Node.js / Express)
...
Pour chaque entrée contrôlée par l'utilisateur (`req.params`, `req.query`, `req.body`, `req.headers`, `req.cookies`), suis la donnée jusqu'aux
