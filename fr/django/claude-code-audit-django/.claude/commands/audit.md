---
description: Audit de sécurité white-box des changements en cours (Django / DRF)
argument-hint: "[chemin optionnel à auditer]"
allowed-tools: Bash(git status:*), Bash(git diff:*), Bash(git log:*), Read, Grep, Glob
---

# /audit - Audit de sécurité white-box (Django / DRF)
...
Pour chaque entrée contrôlée par l'utilisateur (`request.GET`, `request.POST`, `request.data`, kwargs d'URL, en-têtes, cookies), suis la donnée jusqu'aux
