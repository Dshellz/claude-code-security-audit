...
Pour chaque entrée contrôlée par l'utilisateur (`request.args`, `request.form`, `request.json`, `request.files`, en-têtes, cookies), suis la donnée jusqu'aux
